...
```bash
gleam run -- <day>  # Run a specific day
gleam run -- 0      # Run all days
```
...
- [hexdocs - gleam_stdlib](https://hexdocs.pm/gleam_stdlib/index.html)
- [hex packages](https://hex.pm/packages/)
